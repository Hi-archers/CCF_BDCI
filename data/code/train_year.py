...
def parse_args():
    ...
    parser.add_argument('--train_path', default='../user_data/train_data/year_train.txt', help='traning set file.')
    parser.add_argument('--val_path', default=  '../user_data/train_data/year_val.txt', help='validation set file.')
    parser.add_argument('--save_file', default= '../user_data/model/t5-large-ssm-year', help='save model path.')
