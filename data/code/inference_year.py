...
def parse_args():
    ...
    parser.add_argument('--model_path', default="../user_data/model/t5-large-ssm-year/best_ckpt", help='Model path.')
    ...
    parser.add_argument('--result_file', default='../user_data/result/year.csv', help='Save result path.')
