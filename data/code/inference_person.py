...
def parse_args():
    ...
    parser.add_argument('--model_path', default="../user_data/model/t5-large-ssm-person/best_ckpt", help='Model path.')
    ...
    parser.add_argument('--result_file', default='../user_data/result/person.csv', help='Save result path.')
